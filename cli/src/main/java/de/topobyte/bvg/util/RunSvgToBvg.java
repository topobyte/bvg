...
public class RunSvgToBvg
{

	private final static String HELP_MESSAGE = RunSvgToBvg.class.getSimpleName()
			+ " [options] [input] [output]";

	private static void printHelpAndExit(Options options)
	{
		new HelpFormatter().printHelp(HELP_MESSAGE, options);
		System.out.println("usage: " + RunSvgToBvg.class.getSimpleName()
				+ " [input] [output]");
		System.exit(1);
	}
